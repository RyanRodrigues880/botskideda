...
async function start(client) {
  client.onMessage(async (message) => {
    ...
    if (message.body === '!comandos') {
        ...
        /n #caralhow - Caralhoooow pqp!/n
        #dados - Dados Pessoaix /n
        #desafiando - Tá desafiando? /n
        #eunaovi - Eu não vi, merda! /n
        #irmandade - Eu quero que se foda... /n
        #jeffgemendo - Jeff gemendo. /n
        #jhonny - Lipe e Jhonny /n
        #lipegay - Lipe Gay /n
        #mijao - Mijou sim!! /n
        #painel - Painel /n
        #qidejeff - Qi de Nordestino (Jeff) /n
        #qideleo - Qi de Leo /n
        #real - É real isso dai. /n
        #renanculpado - Renan culpado. /n
        #risada - Risada /n
        #rodriguinha - Palhaço Cacetão - Historia da Rodriguinha /n
        #superior - Quer tentar sair como superior? /n
        #tafudido - Tá fudido! /n
        #lipetrauma - Trauma do Lipe /n
        #yesbaby - Yes baby, thank you. /n
        #aline - Aline, por favor... /n
        #eliasorando - Elias orando. /n
        #poderoso - Esse filha da puta... /n
        #eliasgolpe - Elias golpe. /n
        #tranquilo - Tranquilaço. /n
