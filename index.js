...
async function start(client) {
  client.onMessage(async (message) => {
    ...
    audioMessage('vtnclipe', 'mpeg', true);
    audioMessage('confusao', 'mpeg', true);
    audioMessage('brahma', 'mpeg', true);
    audioMessage('vereador', 'mpeg', true);
    audioMessage('dj', 'mpeg', true);
    audioMessage('vtnc', 'mpeg', true);
    audioMessage('carta', 'mpeg', true);
